...
describe('#POST /todos', () => {
  ...
  describe('GET /todos', () => {
    it('should get all todos of user number One', (done) => {
      request(app)
        .get('/todos')
        .set('x-auth', users[0].tokens[0].token)
        .expect(200)
  ...
  describe('GET /todos/:id', () => {
    ...
    it('should not return todo doc with given id from other user', (done) =>{
        request(app)
  ...
  describe('PATCH /todos/:id', () => {
    ...
    it('should update todo from another user', (done) => {
